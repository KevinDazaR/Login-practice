let LISTA_USUARIO = [
  ...
  {
    name: "Manuela",
    email: "manuelaAlejandra@gmail.com",
    password: "mauela123",
    gender: "male",
  },
  {
    name: "Luis",
    email: "luisAlvarez@gmail.com",
    password: "luis123",
    gender: "male",
  },
];
...
btnLogin.addEventListener("click", function login(event) {
  ...
  LISTA_USUARIO.forEach(function (person) {
    if (
      person.email === loginName.value &&
      person.password === loginPassword.value
    ) {
      sessionStorage.setItem(
        "usuario",
        JSON.stringify(person, 2)
      ); /* ERROR AL VALIDAR USUARIO POR SCOPE , CREADO DENTRO DE UNA FUCION */
